...
> = {
  ...
  Rare: {
    ...
    dot: 'bg-blue-500',
    legend: 'bg-blue-500/10 border-blue-500/25 text-blue-700 dark:text-blue-400',
  ...
  Epic: {
    ...
    dot: 'bg-violet-500',
    legend: 'bg-violet-500/10 border-violet-500/25 text-violet-700 dark:text-violet-400',
    ring: 'ring-violet-500/50',
  },
  Legendary: {
    card: 'bg-brand-yellow/10 border-brand-yellow/30',
    label: 'text-amber-700 dark:text-brand-yellow',
    chip: 'bg-brand-yellow/20 text-amber-700 dark:text-brand-yellow',
    dot: 'bg-brand-yellow',
    legend: 'bg-brand-yellow/10 border-brand-yellow/25 text-amber-700 dark:text-brand-yellow',
