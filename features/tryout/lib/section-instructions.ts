...
export const TRYOUT_SECTION_INSTRUCTIONS: Record<TryoutSectionValue, TryoutSectionInstruction> = {
  ...
  CHOKAI: {
    ...
    instructions: [
      'Putar audio terlebih dahulu — beberapa soal mungkin memakai satu audio yang sama.',
      'Kamu bisa memutar ulang audio selama masih di bagian ini.',
      'Jawab berdasarkan apa yang kamu dengar, bukan tebakan sembarangan.',
