...
/**
 * Canonical method catalog — UI metadata only (safe for client components).
 * Runtime enablement lives in PaymentMethodSetting (server).
 */
...
/** Prefer catalog for display after charge. */
